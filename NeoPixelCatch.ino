...
// Booleans to Check if Button was Pressed Correctly
...
void setup() {
  ...
  // Beginning Introduction and Rules
...
// ISP for right button
void rightFlagPushed() {
  rightFlag = 1;
  }

// Function checks if color was correct when right button was pressed, adjusts score or life appriotately 
void rightButtonPushed() {
  if (rightFlag) {
  playerResponded = 1;
    rightFlag = 0;
    unsigned long currentTimeDebounce = millis();
...
// Function checks if color was correct when left button was pressed, adjusts score or life appriotately 
...
void loop() {
  ...
  if (life > 0 && !firstGame) {
    ...
    if (!lightOn && currentMillis - previousMillis >= pixelOnDuration) {
      ...
      switch(randColor) {
        // RED
        case 1: CircuitPlayground.setPixelColor(randNeoPixel, 255, 0, 0); 
        rightButtonScore = 1; 
        break;
        // GREEN
        case 2: CircuitPlayground.setPixelColor(randNeoPixel, 0, 255, 0);
        leftButtonScore = 1; 
        break;
        // BLUE
        case 3:CircuitPlayground.setPixelColor(randNeoPixel, 0, 0, 255); break;
        // YELLOW
        case 4: CircuitPlayground.setPixelColor(randNeoPixel, 255, 130, 0); break;
        // ORANGE
        case 5: CircuitPlayground.setPixelColor(randNeoPixel, 255, 45, 0); break;
        // PURPLE
        case 6: CircuitPlayground.setPixelColor(randNeoPixel, 150, 0, 170); break; 
        }
